...
Output example: [{"type":"emotion","icon":"😰","label":"stressed"},{"type":"energy","icon":"🥱","label":"sleep-deprived"}]`,
  ...
  const DUMP_PROMPT = {
    ko: (refDate) =>
      ...
      '입력: "샘플 디자인 해야하고 내일은 오후 1시에 미용 예약해서 데려가야해. 내일 비도 온다네. 와 지금 집중 진짜 안된다. 답장은 왜 아직도 안와 쉬익쉬익"\n' +
      '출력: [' +
      '{"title":"샘플 디자인","kind":"task","time":null,"date":null,"relatedTo":null},' +
      '{"title":"미용 예약 데려가기","kind":"event","time":"13:00","date":"내일","relatedTo":null},' +
      '{"title":"비 예보 확인","kind":"remember","time":null,"date":"내일","relatedTo":null},' +
      '{"title":"집중 안됨","kind":"feeling","time":null,"date":null,"relatedTo":null},' +
      '{"title":"답장 대기","kind":"remember","time":null,"date":null,"relatedTo":null}]\n' +
      ...
      '출력: [' +
      '{"title":"배가 아파서 걱정","kind":"feeling","time":null,"date":null,"relatedTo":null},' +
      '{"title":"강아지 산책, 목욕탕 다녀옴","kind":"done","time":null,"date":null,"relatedTo":null},' +
      '{"title":"카페에서 집필 중","kind":"done","time":null,"date":null,"relatedTo":null},' +
      '{"title":"운동 가기","kind":"task","time":"19:00","date":"오늘","relatedTo":null},' +
      '{"title":"어떻게 하면 좋을까","kind":"ponder","time":null,"date":null,"relatedTo":null}]\n' +
      'JSON 배열만 응답.\n\n',
    ...
    en: (refDate) =>
      ...
      'Output: [' +
      '{"title":"stomach hurts, worried","kind":"feeling","time":null,"date":null,"relatedTo":null},' +
      '{"title":"walked the dog, went to the bathhouse","kind":"done","time":null,"date":null,"relatedTo":null},' +
      '{"title":"writing at the cafe","kind":"done","time":null,"date":null,"relatedTo":null},' +
      '{"title":"work out","kind":"task","time":"19:00","date":"today","relatedTo":null},' +
      '{"title":"what should I do","kind":"ponder","time":null,"date":null,"relatedTo":null}]\n' +
      'JSON array only.\n\n',
  };
