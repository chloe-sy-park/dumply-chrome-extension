...
const DumplyAccount = (() => {
  ...
  return { requestOtp, verifyOtp, signOut, isSignedIn, getEmail, getUserId, getAccessToken, SUPA_URL, SUPA_KEY, getBalance, getPlan, fetchBalance, fetchUsage, fetchLedger, chat, createCheckout };
})();
