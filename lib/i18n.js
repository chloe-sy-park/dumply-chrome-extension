...
const AlfredoI18n = (() => {
  const STRINGS = {
    ko: {
      ...
      'timeline.stub.before': (time) => `${time} 이전 · 펼치기`,
      'timeline.stub.after': (time) => `${time} 이후 · 펼치기`,
      'nav.menu': '메뉴',
    ...
    en: {
      ...
      'timeline.stub.before': (time) => `Before ${time} · expand`,
      'timeline.stub.after': (time) => `After ${time} · expand`,
      'nav.menu': 'Menu',
