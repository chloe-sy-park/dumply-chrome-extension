...
$('#onboard-next')?.addEventListener('click', advanceOnboarding);
  ...
  $('#btn-hdr-search')?.addEventListener('click', openSearchSheet);
  $('#btn-close-search')?.addEventListener('click', closeSearchSheet);
  $('#search-input')?.addEventListener('input', (e) => renderSearchResults(e.target.value));
  $('#search-sheet')?.addEventListener('click', (e) => { if (e.target === e.currentTarget) closeSearchSheet(); });
  $('#btn-hdr-notif')?.addEventListener('click', openNotifSheet);
  $('#btn-close-notif')?.addEventListener('click', closeNotifSheet);
  $('#notif-sheet')?.addEventListener('click', (e) => { if (e.target === e.currentTarget) closeNotifSheet(); });
